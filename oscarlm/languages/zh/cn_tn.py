...
# -*- coding: utf-8 -*-
# 
# Modified from https://github.com/speechio/chinese_text_normalization/blob/5cb836c86d95e9678f27a2d3997136cbf5f2fc73/TN/cn_tn.py
#
# Authors:
...
def normalize_line(l, to_upper=False, to_lower=False, kaldi_format=False):
    key = ''
    text = ''
    if kaldi_format:
...
if __name__ == '__main__':
    ...
    for n, line in enumerate(ifile):
        normalized = normalize_line(line,
                                    ...
                                    kaldi_format=args.has_key)
        if normalized: # skip empty line in pure text format(without Kaldi's utt key)
    ...
    sys.stderr.write("cn_tn.py: {} lines written in total.\n".format(n))
    sys.stderr.flush()
